...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 font-sans print:bg-white print:pb-0">
      ...
      {/* 
        BULLETPROOF SAFARI PAGE BREAK CSS 
        Swapped "inline-block" for "table" to establish a rigid boundary Safari cannot slice through 
      */}
      <style dangerouslySetInnerHTML={{__html: `
        @media print {
          ...
          /* The magic fix to stop Safari from splitting elements */
          ...
          /* Extra safety to ensure photos themselves are never broken */
